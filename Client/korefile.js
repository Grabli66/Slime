...
Promise.all([Project.createProject('build/windows-build', __dirname), Project.createProject('c:/KodeStudio/resources/app/extensions/kha/Kha', __dirname), Project.createProject('c:/KodeStudio/resources/app/extensions/kha/Kha/Kore', __dirname)]).then((projects) => {
